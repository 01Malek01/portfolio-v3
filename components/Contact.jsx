    ...
    >
      ...
      <div className="relative flex items-center justify-center">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, top: '-10rem' }}
          ...
          >
            <div className="flex flex-col items-center justify-center">
              ...
              <span className=" font-extrabold text-white drop-shadow-lg text-center">01125485384</span>
              <Circle ref={div1Ref}>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, left: '-8rem' }}
          transition={{ duration: 1.5 }}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, right: '-8rem' }}
          transition={{ duration: 1.5 }}
